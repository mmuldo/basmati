...
(def-doom-theme muruusa-forest
  ...
  ((bg         '("#171006" nil           nil))
   ...
   (bg-alt     '("#23190a" nil           nil))
   (fg-alt     '("#eccfb6" nil           nil))

   ;; These should represent a spectrum from bg to fg, where base0 is a starker
   ;; bg and base8 is a starker fg. For example, if bg is light grey and fg is
   ;; dark grey, base0 should be white and base8 should be black.
   (base0      '("#0f0a03" nil           nil))
   (base1      '("#171006" nil           nil))
   (base2      '("#2c200e" nil           nil))
   (base3      '("#523d1e" nil           nil))
   (base4      '("#775e3a" nil           nil))
   (base5      '("#9f7856" nil           nil))
   (base6      '("#c19d7d" nil           nil))
   (base7      '("#e2be9f" nil           nil))
   (base8      '("#efd2b8" nil           nil))

   (grey       base4)
   (red        '("#813b22" nil           nil))
   (orange     '("#bc775e" nil           nil))
   (green      '("#62743b" nil           nil))
   (teal       '("#9bb367" nil           nil))
   (yellow     '("#ae963b" nil           nil))
   (blue       '("#7e8e82" nil           nil))
   (dark-blue  '("#47534a" nil           nil))
   (magenta    '("#807c6a" nil           nil))
   (violet     '("#575342" nil           nil))
   (cyan       '("#85815e" nil           nil))
   (dark-cyan  '("#c3bf9e" nil           nil))
  ...
  (((line-number &override) :foreground base4)
   ...
   ;;;; elscreen
   (elscreen-tab-other-screen-face :background "#d1be76" :foreground "#62743b")
   ;;;; ivy
